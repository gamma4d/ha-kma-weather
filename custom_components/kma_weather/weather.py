"""KMA weather entity — current conditions + native hourly/daily forecast.

The 3-hour forecast is exposed separately (sensor.py) because Home Assistant's
WeatherEntity has no native 3-hourly forecast type (only hourly/daily/twice_daily).
"""
